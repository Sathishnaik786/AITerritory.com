...
const AdvertisePage: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Advertise With Us | AI Territory"
        description="Reach a targeted audience of AI enthusiasts and professionals. Advertise your tool, product, or service on AI Territory."
      />
