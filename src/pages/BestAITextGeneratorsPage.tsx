...
const BestAITextGeneratorsPage = () => {
  ...
  const fetchTools = () => {
    ...
    fetch(`${apiBaseUrl}/tools/ai-language-models?${params.toString()}`)
      .then(res => {
  ...
  return (
    <>
      <SEO
        title="Best AI Text Generators | AITerritory"
        description="Explore advanced AI Text Generators for content creation, blogs, and business automation. Find top-rated tools on AITerritory."
        image="/og-default.png"
        keywords="AI text generators, content creation, language models, AI writing tools, text generation"
      />
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground">
            Explore advanced AI text generators for content creation, blogs, and business automation
          </p>
        </div>
