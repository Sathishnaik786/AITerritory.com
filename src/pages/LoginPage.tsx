...
const LoginPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-3 sm:p-4">
      <motion.div
      ...
      >
        ...
        <div className="text-center mb-4 sm:mb-6 md:mb-8">
          ...
          >
            Sign in to access your personalized dashboard, saved tools, and exclusive features
          </motion.p>
        </div>
          ...
          <SignIn 
            appearance={{
              elements: {
                ...
                formButtonPrimary: "bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-2 sm:py-2.5 md:py-3 px-3 sm:px-4 md:px-6 rounded-lg sm:rounded-xl transition-all duration-200 text-xs sm:text-sm md:text-base",
                formFieldInput: "border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg sm:rounded-xl px-2.5 sm:px-3 md:px-4 py-2 sm:py-2.5 md:py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-xs sm:text-sm md:text-base",
                formFieldLabel: "text-gray-700 dark:text-gray-300 font-medium text-xs sm:text-sm md:text-base",
                footerActionLink: "text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 text-xs sm:text-sm md:text-base",
