...
const BestAIArtGeneratorsPage = () => {
  ...
  const fetchTools = () => {
    ...
    fetch(`${apiBaseUrl}/tools/ai-art-generators?${params.toString()}`)
      .then(res => {
  ...
  return (
    <>
      <SEO
        title="Best AI Art Generators | AITerritory"
        description="Turn ideas into beautiful artwork with AI Art Generators. Find and compare top tools for artists and designers."
        image="/og-default.png"
        keywords="AI art generators, digital art, creative tools, AI artwork, artistic AI"
      />
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground">
            Turn ideas into beautiful artwork with AI Art Generators
          </p>
        </div>
      ...
      {/* FAQ Section */}
      <FAQ category="ai-art-generators" />
    </>
  );
};
