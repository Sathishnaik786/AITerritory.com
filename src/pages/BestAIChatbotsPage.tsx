...
const BestAIChatbotsPage = () => {
  ...
  const fetchTools = () => {
    ...
    fetch(`${apiBaseUrl}/tools/ai-chatbots?${params.toString()}`)
      .then(res => {
  ...
  return (
    <>
      <SEO
        title="Best AI Chatbots | AITerritory"
        description="Discover the best AI Chatbots for automation, customer support, and productivity at AITerritory. Explore top tools updated daily."
        image="/og-default.png"
        keywords="AI chatbots, conversational AI, customer support automation, AI assistants, chatbot tools"
      />
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground">
            Discover the best AI chatbots for automation, customer support, and productivity
          </p>
        </div>
