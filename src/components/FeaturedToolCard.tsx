...
const FeaturedToolCard: React.FC<FeaturedToolCardProps> = ({ tool }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-100 dark:border-gray-700 flex flex-col h-full p-5">
      ...
      <div className="flex items-center justify-end mt-auto pt-2">
        <a
          ...
          className="bg-white border border-blue-400 text-blue-600 hover:bg-blue-50 hover:border-blue-600 font-semibold px-6 py-2 rounded-xl shadow-sm flex items-center gap-2"
        >
