...
import { getFeatureRequests, FeatureRequest } from '@/services/submissionService';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Skeleton } from '@/components/ui/skeleton';

const FeatureRequestsAdmin: React.FC = () => {
  const { data: submissions, isLoading, error } = useQuery<FeatureRequest[], Error>({
              ...
              {isLoading ? (
                ...
                submissions?.map((submission) => (
                  <TableRow key={submission.id}>
                    <TableCell>{submission.feature}</TableCell>
