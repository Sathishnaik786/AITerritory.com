/*
  # Initial schema setup for AI Territory
  ...
  2. Indexes
    ...
    - Add full-text search index for tools
  3. Security
...
DROP POLICY IF EXISTS "Public read access for tool_tags" ON tool_tags;
DROP POLICY IF EXISTS "Public read access for sub_tools" ON sub_tools;
